      ...
      >
        <div className="flex min-h-screen flex-col">
          ...
          <div className="grid flex-1 md:grid-cols-[250px_1fr] lg:grid-cols-[300px_1fr]">
            <aside className="border-r bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 h-[100dvh] sticky top-0">
            ...
            <main className="relative">
              <div className="prose prose-slate dark:prose-invert max-w-none p-6 lg:p-10">
                {children}
              </div>
            </main>
          </div>
