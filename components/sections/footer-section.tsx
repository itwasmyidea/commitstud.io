...
import { footerLinks, navItems, resourceLinks, companyLinks, footerCopyright } from "@/lib/content"
      ...
      <Container>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-zinc-800/50">
          <div className="mb-4 md:mb-0 flex items-center">
            <a href="https://softx.ca" target="_blank" rel="noopener noreferrer">
              <Image 
                src="/softx-logo.svg" 
                alt="SofTx"
                width={60}
          ...
          <p className="text-xs text-zinc-500">
            © {new Date().getFullYear()} {footerCopyright.prefix} {footerCopyright.suffix}{" "}
            <a 
              href={footerCopyright.company.url} 
              className="hover:text-white transition-colors duration-200" 
              target="_blank" 
              rel="noopener noreferrer"
            >
              {footerCopyright.company.name}
            </a>
          </p>
