  ...
  return (
    <header className="border-b border-zinc-800/80">
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        <div className="flex items-center">
          <Link href="/" className="flex items-center group">
            <svg 
              ...
              className="text-white mr-2 group-hover:text-blue-500 transition-colors"
            >
            ...
            <span className="font-medium text-white group-hover:text-blue-500 transition-colors">
        ...
        <Link 
          href="/" 
          className="px-4 py-1.5 text-sm rounded-full border border-zinc-700 text-zinc-300 hover:text-white hover:border-zinc-500 transition-colors"
        >
          Back to Site
        </Link>
      </div>
